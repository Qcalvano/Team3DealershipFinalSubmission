...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        userLogin(uList, carList, dList, saList, custList);
    }
     ...
     * @param saList    An ArrayList of Sales associate objects.
     * @param custList  An ArrayList of Customer objects.
     * @author          Quenten Calvano
     * @version         1.0
     * @since           2020-24-06
     */
    public static void userLogin(ArrayList<User> uList, ArrayList<Car> carList, ArrayList<Dealership> dList, ArrayList<SalesAssociate> saList, ArrayList<Customer> custList){
        ...
        do {
            ...
            if (input.equals("1")) {
                ...
                if (accessVerified == true) {
                    User.userMenu(carList, dList, uList, saList, custList);
